...
public class IngestionPipelineTests
{
    ...
    public async Task Ingests_each_entry_with_embedding_and_content_hash()
    {
        ...
        var entries = new[]
        {
            new ManifestEntry("PRIN 2.1", "PRIN", "The Principles", "https://handbook.fca.org.uk/handbook/PRIN/2/1.html", "Summary of the Principles."),
            new ManifestEntry("SYSC 4.1", "SYSC", "General organisational requirements", "https://handbook.fca.org.uk/handbook/SYSC/4/1.html", "Summary of organisational requirements."),
        };
